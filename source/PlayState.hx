...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['D U M B A S S', 0.2], //From 0% to 19%
		['DUMBASS', 0.4], //From 20% to 39%
		['Dumbass', 0.5], //From 40% to 49%
		['dumbass', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Great', 0.9], //From 80% to 89%
		['Killer!', 1], //From 90% to 99%
		['HOLY SHIT!!!!!!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	public var dontplayagainLol:Bool = false;
			...
			case 'landFight':
					{
						...
						soldiers = new FlxSprite(-1050, -10);
			...
			case 'landHostage':
					{
						...
						soldiersBoppin = new FlxSprite(-500, -30);
	...
	override public function update(elapsed:Float)
	{
		/*if (FlxG.keys.justPressed.NINE)
		{
			...
			if (curSong == 'Crossfire' && curStep == 7)
			{
				rockyshooting.animation.play('idle', true);
		    }
		if (curSong == 'Crossfire' && curStep == 0)
			{
				soldiers.animation.play('idle', true);
		    }
		if (curSong == 'Crossfire' && curStep == 1)
			{
				soldiers2.animation.play('idle', true);
		    }
